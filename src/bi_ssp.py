...
def generate_trans_sale_detail(output_path, str_date, str_time, str_stime, store, data):
    ...
    try:
      ...
      for d in data:
        ...
        f.write("{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}".format(
          ...
          d['sku'],
          d['quantity'],
          d['price_before_override'],
          d['price_after_override'],
          d['price_override_flag'],
          d['total_sale'],
          d['vat_rate'],
          d['vat_amt'],
          d['discount_code1'],
      ...
      print('[AutoPOS] - BI SSP transaction sale detail create files error: {}: '.format(e))


def generate_trans_tendor_detail(output_path, str_date, str_time, str_stime, store, data):
  ...
  with open(file_fullpath, 'w') as f, open(log_fullpath, 'w') as l:
    try:
      ...
      print('[AutoPOS] - BI SSP transaction tendor detail create files error: {}: '.format(e))


def generate_trans_installment(output_path, str_date, str_time, str_stime, store, data):
  ...
  with open(file_fullpath, 'w') as f, open(log_fullpath, 'w') as l:
    try:
      ...
      print('[AutoPOS] - BI SSP transaction installment create files error: {}: '.format(e))


def generate_trans_dcpn(output_path, str_date, str_time, str_stime, store, data):
  ...
  with open(file_fullpath, 'w') as f, open(log_fullpath, 'w') as l:
    try:
      ...
      print('[AutoPOS] - BI SSP transaction dpcn create files error: {}: '.format(e))
...
def query_store():
  with connect_psql() as conn:
    with conn.cursor(cursor_factory=psycopg2.extras.DictCursor) as cursor:
      cursor.execute("select store_code from mv_autopos_bi_ssp_trans_sale_detail group by store_code")
...
def main():
  ...
  target_path = os.path.join(parent_path, 'output/autopos/bissp', str_date + str_time)
  ...
  try:
    ...
    for store in stores:
      generate_trans_sale_detail(target_path, str_date, str_time, str_stime, store, query_transaction_sale_detail(store))
      generate_trans_tendor_detail(target_path, str_date, str_time, str_stime, store, query_transaction_tendor_detail(store))
      generate_trans_installment(target_path, str_date, str_time, str_stime, store, query_transaction_installment(store))
      generate_trans_dcpn(target_path, str_date, str_time, str_stime, store, query_transaction_dcpn(store))
  except Exception as e:
    print(e)
