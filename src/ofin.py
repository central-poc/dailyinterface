    ...
    try:
      ...
      for d in data:
        ...
        dat.write('''
          ...
          {:4}{:25}{:25}{:25}{:1}{:10}{:240}
        '''.format(
          d['ofin_branch_code'], d['ofin_cost_profit_center'], 
          d['account_code'], d['subaccount_code'], 
          d['business_date'], d['debit'], d['credit'],
          d['bu'], d['journal_category_name'], d['journal_source_name'],
          d['batch_name'], d['seq'], d['ofin_for_cfs'], d['account_description']
        ))
        count = count + 1
