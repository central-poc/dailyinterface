        ...
        with conn.cursor(as_dict=True) as cursor:
            ...
            Select top 500 * from (
                ...
                SELECT
                    ...
                    '01'as TransType,
                    'C' as TransSubType,
                    REPLACE(CONVERT(VARCHAR(10), c.DocDate, 103), '/', '') + '_00:00:00:000' as TransDate,
                    REPLACE(CONVERT(VARCHAR(10), c.DocDate, 103), '/', '') as BusinessDate,
                    ISNULL(REPLACE(CONVERT(VARCHAR(10), h.InvoiceDate, 103), '/', ''),'') as InvoiceDate,
                    ISNULL(REPLACE(CONVERT(VARCHAR(10), h.DeliveryDate, 103), '/', ''),'') as DeliveryDate,
                    '' as EarnOnlineFlag,
                    h.T1CNumber as T1CCardNo,
                ...
                SELECT
                    ...
                    'T' as TransSubType,
                    REPLACE(CONVERT(VARCHAR(10), t.DocDate, 103), '/', '') + '_00:00:00:000' as TransDate,
                    REPLACE(CONVERT(VARCHAR(10), t.DocDate, 103), '/', '') as BusinessDate,
                    ISNULL(REPLACE(CONVERT(VARCHAR(10), h.InvoiceDate, 103), '/', ''),'') as InvoiceDate,
                    ISNULL(REPLACE(CONVERT(VARCHAR(10), h.DeliveryDate, 103), '/', ''),'') as DeliveryDate,
                    '' as EarnOnlineFlag,
                    h.T1CNumber as T1CCardNo,
