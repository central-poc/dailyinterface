        ...
        with conn.cursor(as_dict=True) as cursor:
            ...
            Select top 500 * from (
                SELECT
                    ...
                    d.OriginalSeq as OriginalItemSequenceNo,
                    h.DisplayReceiptNo,
                    h.ReturnAllFlag,
                ...
                SELECT
                    ...
                    '01'as TransType,
                    'C' as TransSubType,
                    c.DocDate as TransDate,
                    c.DocDate as BusinessDate,
                    h.InvoiceDate,
                    h.DeliveryDate,
                    '' as EarnOnlineFlag,
                    h.T1CNumber as T1CCardNo,
                    ...
                    0 as VatAmount,
                    '' as TenderType,
                    CouponNumber as TenderRefNo,
                    ISNULL(H.OriginalReceipt,'') as OriginalReceiptNo,
                    SeqNo as OriginalItemSequenceNo,
                    h.DisplayReceiptNo,
                    h.ReturnAllFlag,
                    ISNULL(h.SBLCnclRedeemTxnID,'') as SBLCnclRedeemTxnID,
                    h.TotalAmount as TotalAmount
                ...
                SELECT
                    ...
                    'T' as TransSubType,
                    t.DocDate as TransDate,
                    t.DocDate as BusinessDate,
                    h.InvoiceDate,
                    h.DeliveryDate,
                    '' as EarnOnlineFlag,
                    h.T1CNumber as T1CCardNo,
